        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: COLOR.BACKGROUNDCOLOR }}>
            ...
            <View style={{ flexDirection: KEY.ROW, marginBottom: 10 }}>
                ...
                <TouchableOpacity style={styles.deactiveTabStyle}>
                    <Text style={styles.deactiveTextStyle}>{"Paid"}</Text>
                </TouchableOpacity>

                <TouchableOpacity style={styles.deactiveTabStyle}>
                    <Text style={styles.deactiveTextStyle}>{"Received"}</Text>
                </TouchableOpacity>

                <TouchableOpacity style={styles.deactiveTabStyle}>
                    <Text style={styles.deactiveTextStyle}> {"Added"}</Text>
                </TouchableOpacity>
                ...
                <View style={{ justifyContent: KEY.CENTER, alignItems: KEY.CENTER }}>
                    ...
                    <View style={styles.transactionView}>
                        <View style={{
                            ...
                            <Ionicons name='wallet-outline' size={45}
                                style={{
                                    color: COLOR.WHITE,
                                    // marginRight: 20,
                                    marginTop: 15,
                            ...
                            <View style={{ height: 20, width: 20, borderRadius: 100, left: -20, top: -20, backgroundColor: COLOR.WHITE }} >
                        ...
                        <View style={{ flexDirection: KEY.COLUMN, justifyContent: KEY.SPACEBETWEEN, marginTop: 10, marginBottom: 10 }}>
                            ...
                            <Text style={{ fontSize: FONT.FONT_SIZE_14, marginLeft: -20, color: COLOR.GRANITE_GRAY }}>{"Balance $50.00"}</Text>
                        </View>
                    </View>
